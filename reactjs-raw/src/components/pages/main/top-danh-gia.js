                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6 col-12">
                                        <div className="list-image overlay">
                                            ...
                                            <a href="#" className="buy" onClick={() => handleAddToCart(item.dien_thoai.chi_tiet_dien_thoai[0].id)}><i className="fa fa-shopping-bag"></i></a>
                                            <h6>{item.dien_thoai.ten} - {item.dien_thoai.chi_tiet_dien_thoai[0].gia_ban} VNĐ - {item.dien_thoai.chi_tiet_dien_thoai[0].mau_sac.ten} - {item.dien_thoai.chi_tiet_dien_thoai[0].dung_luong.ten}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
